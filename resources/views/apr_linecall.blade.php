        ...
        axios.get('{{ route('data_first') }}')
            .then(function(res) {
                ...
                res.data.datafirst.map((show) => {
                    ...
                    // Only display the card if empno is in matchArray


                    // No card will be shown if empno is not found in matchArray


                    // If empno is not in matchArray, nothing will be shown, as the code inside the `if` block won't execute.
